...
void setup() {
  ...
  //pinMode(LEDCONSO, OUTPUT);
  digitalWrite(LEDHC, LOW);
  //digitalWrite(LEDCONSO, LOW);
  i=0;
...
void HandleDataRx(char DataRx[], int Pipe)
{
  ...
  if (DataRx[0]=='1')
  {
    Serial.print("Fil Pilote 1, value: ");
  ...
  {
    Serial.print("Fil Pilote 2, value: ");
  ...
  {
    Serial.print("Fil Pilote 3, value: ");
    Serial.println(String(resultString));
    if (DataRx[2] == '1') {
  ...
  {
    Serial.print("Fil Pilote 4, value: ");
    Serial.println(String(resultString));
    if (DataRx[2] == '1') {
